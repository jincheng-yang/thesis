...
%---DELETED---% truefont, % just turn it on when using Windows
%---DELETED---% nofont, % remember to manally set the fonts
pdflinks,
% colorlinks,
% compact,
]{xjtuthesis}
...
\begin{figure}[!ht]
\centering
\includegraphics[scale=0.68]{figures/xin_2.jpg}
\caption{$V$的取值变化}
% \label{fig:label}
\end{figure}
...
\begin{center}
\noindent
\includegraphics[scale=1]{translation/1}\\
\includegraphics[scale=1]{translation/2}\\
\includegraphics[scale=1]{translation/3}\\
\includegraphics[scale=1]{translation/4}\\
\includegraphics[scale=1]{translation/5}\\
\includegraphics[scale=1]{translation/6}
\end{center}
